    ...
    <div className={`grid grid-cols-2 overflow-hidden gap-[50vw]`}>
      ...
      <div className={`${vazir.className}`}>
        <div className={`${styles.wholePage} overflow-hidden`}>
          <div
            className={`absolute overflow-hidden -translate-x-[50vw] hover:cursor-pointer w-48 h-48 justify-center grid grid-cols-2 grid-rows-2 text-center items-center bg-gradient-to-r from-[#EB4132] to-[#DD392B] rounded-full p-6 z-10`}
              ...
              <div className="w-full items-center text-center">
                ...
                >
                  <Form className={styles.form}>
                    <div
                      className="flex flex-row gap-3 justify-between w-9/10"
                      dir="rtl"
                    >
                      <CustomInput
                    ...
                    <div className="flex flex-row gap-3 justify-between w-9/10">
                      <CustomInput
                        containerClassName="w-3/10"
                        name="countrycode"
                        readOnly={true}
                        placeholder="+98"
                        icon={Smartphone}
                    ...
                    <CustomInput
                      containerClassName="w-9/10"
                      name="password"
                      placeholder="رمز عبور"
                      onIconClick={() => Sethidepass((prev) => !prev)}
                    ...
                    <CustomInput
                      ...
                      onIconClick={() => Sethideconfpass((prev) => !prev)}
