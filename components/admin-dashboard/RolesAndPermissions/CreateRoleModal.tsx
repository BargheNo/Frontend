...
import { X, Loader2, Vote, Check } from "lucide-react";
	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			...
			>
				...
				{/* <div
					className={`fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 rtl`}
				> */}
				...
				<div className="flex justify-end gap-4 mt-6">
					<button
					disabled={isSaving}
					className="px-4 py-2 text-gray-600 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 disabled:opacity-50"
				>
					انصراف
				</button>
				<button
					...
					className="px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 cursor-pointer disabled:opacity-50 flex items-center gap-2"
				>
