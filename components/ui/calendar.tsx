...
export function Calendar({
    ...
    return (
        <DayPicker
			...
			disabled={onlyFuture ? { before: new Date() } : undefined}
...
function CalendarDayButton({
    ...
    onlyFuture,
    ...props
}: React.ComponentProps<typeof DayButton> & { onlyFuture?: boolean }) {
    const defaultClassNames = getDefaultClassNames();
    ...
    const isDisabled = onlyFuture && !isFuture;
    return (
        <Button
            ref={ref}
            variant="ghost"
            ...
            className={cn(
                ...
                !isDisabled
                    ? "hover:bg-[#fa672d] cursor-pointer"
